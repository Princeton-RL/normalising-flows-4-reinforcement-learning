...
def save_params(params, save_dir, epoch):
...
def load_params(save_dir, epoch):
    """Load the model parameters from a file.

    Args:
        save_dir: Directory where the parameters are saved.
        epoch: Epoch number.

    Returns:
        FrozenDict containing the model parameters.
    """
